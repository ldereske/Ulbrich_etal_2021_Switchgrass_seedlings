...
day_t0_germ_model_pres= lm((t0_germ)^-1~precip*soil_root+as.factor(block), data= dataSG_seed_1st_germ_pres)
qqPlot(stdres(day_t0_germ_model_pres))
hist(stdres(day_t0_germ_model_pres))
shapiro.test(stdres(day_t0_germ_model_pres))
#0.9834
boxCox(day_t0_germ_model_pres)

Anova(day_t0_germ_model_pres, type=3)
#precip           0.01322  1   4.5893  0.041009 *  
#soil_root        0.02531  1   8.7847  0.006141 ** 
#as.factor(block) 0.03116  4   2.7039  0.050628 .    
emmeans(day_t0_germ_model_pres, ~precip)
emmeans(day_t0_germ_model_pres, pairwise~soil_root)
emmeans(day_t0_germ_model_pres, pairwise~soil_root|precip)


day_t0_germ_model_pres_no_block= lm((t0_germ)^-1~precip*soil_root, data= dataSG_seed_1st_germ_pres)
qqPlot(stdres(day_t0_germ_model_pres_no_block))
hist(stdres(day_t0_germ_model_pres_no_block))
shapiro.test(stdres(day_t0_germ_model_pres_no_block))
#0.8381
boxCox(day_t0_germ_model_pres_no_block)

Anova(day_t0_germ_model_pres_no_block, type=3)
#precip           0.01109  1   3.1730 0.08436 .  
#soil_root        0.02538  1   7.2644 0.01111 *  

emmeans(day_t0_germ_model_pres_no_block, pairwise~soil_root|precip)

AIC(day_t0_germ_model_pres,day_t0_germ_model_pres_no_block)
...
day_t0_germ_model_orig= lm((t0_germ)^-2~precip*soil_root+as.factor(block), data= dataSG_seed_1st_germ_orig)
qqPlot(stdres(day_t0_germ_model_orig))
hist(stdres(day_t0_germ_model_orig))
shapiro.test(stdres(day_t0_germ_model_orig))
#0.1707
boxCox(day_t0_germ_model_orig)

Anova(day_t0_germ_model_orig, type=3)
#nada sig  
emmeans(day_t0_germ_model_orig, ~precip)
emmeans(day_t0_germ_model_orig, pairwise~soil_root)
emmeans(day_t0_germ_model_orig, pairwise~soil_root|precip)


day_t0_germ_model_orig_no_block= lm((t0_germ)^-2~precip*soil_root, data= dataSG_seed_1st_germ_orig)
qqPlot(stdres(day_t0_germ_model_orig_no_block))
hist(stdres(day_t0_germ_model_orig_no_block))
shapiro.test(stdres(day_t0_germ_model_orig_no_block))
#0.8381
boxCox(day_t0_germ_model_orig_no_block)

Anova(day_t0_germ_model_orig_no_block, type=3)
#precip           0.01109  1   3.1730 0.08436 .  
#soil_root        0.02538  1   7.2644 0.01111 *  

emmeans(day_t0_germ_model_orig_no_block, pairwise~soil_root|precip)

AIC(day_t0_germ_model_orig,day_t0_germ_model_orig_no_block)
...
seed_germ_model_pres= glm((germinated)~precip*soil_root+as.factor(block), data= fin_dataSG_seed_surv_pres,family="binomial")
...
seed_germ_model_orig= glm((germinated)~precip*soil_root+as.factor(block), data= fin_dataSG_seed_surv_orig,family="binomial")
...
seed_num_germ_model_pres= lm((tot_num_germ)~precip*soil_root+as.factor(block), data= fin_dataSG_seed_surv_pres_tot_seedling)
qqPlot(stdres(seed_num_germ_model_pres))
hist(stdres(seed_num_germ_model_pres))
shapiro.test(stdres(seed_num_germ_model_pres))
#p-value = 0.1838

Anova(seed_num_germ_model_pres, type=3)
#soil_root         3.750  1  6.6402  0.01285 *  
#as.factor(block)  5.567  4  2.4642  0.05639 .  
...
qqPlot(stdres(seed_num_germ_model_pres_no_block))
hist(stdres(seed_num_germ_model_pres_no_block))
shapiro.test(stdres(seed_num_germ_model_pres_no_block))
#p-value = 0.0245
...
seed_num_germ_model_orig= lm(sqrt(tot_num_germ+1)~precip*soil_root+as.factor(block), data= fin_dataSG_seed_surv_orig_tot_seedling)
qqPlot(stdres(seed_num_germ_model_orig))
hist(stdres(seed_num_germ_model_orig))
shapiro.test(stdres(seed_num_germ_model_orig))
#p-value = 0.2825
...
qqPlot(stdres(seed_num_germ_model_orig_no_block))
hist(stdres(seed_num_germ_model_orig_no_block))
shapiro.test(stdres(seed_num_germ_model_orig_no_block))
#p-value = 0.08012
...
seed_surv_germ_model_pres= glm(surv_germ~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_pres_w_germ, family="binomial")
...
seed_surv_germ_model_orig= glm(surv_germ~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_orig_w_germ, family="binomial")
...
fin_dataSG_biomass_seed_surv_trt_w_germ %>% group_by(precip) %>% summarise_at("total_biomass", funs(n(),mean,sd,se=sd(.)/sqrt(n())))
## A tibble: 2 x 5
#precip     n  mean    sd     se
#<fct>  <int> <dbl> <dbl>  <dbl>
...
fin_dataSG_biomass_seed_surv_trt_w_germ %>% group_by(precip,soil_root) %>% summarise_at("total_biomass", funs(n(),mean,sd,se=sd(.)/sqrt(n())))
...
seed_biomas_model_pres= lm((total_biomass)~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_pres_w_germ)
...
seed_biomas_model_orig= lm(log(total_biomass)~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_orig_w_germ)
...
fin_dataSG_biomass_seed_surv_trt_w_germ %>% group_by(precip) %>% summarise_at("root_shoot", funs(n(),mean,sd,se=sd(.)/sqrt(n())))
(18.3-11.6)/11.6

fin_dataSG_biomass_seed_surv_trt_w_germ %>% group_by(precip,soil_root) %>% summarise_at("root_shoot", funs(n(),mean,sd,se=sd(.)/sqrt(n())))
#drought presence
(4.88-10.4)/10.4
...
root_shoot_seed_model_pres= lm(log(root_shoot)~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_pres_w_germ)
...
root_shoot_seed_model_orig= lm(log(root_shoot)~precip*soil_root+as.factor(block), data= fin_dataSG_biomass_seed_surv_orig_w_germ)
...
trans_biomas_model_pres= lm((total_biomass_0+.001)^(1/4)~precip*soil_root+as.factor(block), data= data_SG_biomass_trans_surv_pres)
...
trans_biomas_model_orig= lm((total_biomass_0+0.001)^(1/4)~precip*soil_root+as.factor(block), data= data_SG_biomass_trans_surv_orig)
...
root_shoot_model_pres_na= lm((root_shoot)^(1/4)~precip*soil_root+as.factor(block), data= data_SG_biomass_trans_surv_pres_na)
...
root_shoot_model_orig_na= lm(log(root_shoot)~precip*soil_root+as.factor(block), data= data_SG_biomass_trans_surv_orig_na)
...
drought_surv_model_pres= glm(surv~soil_root+as.factor(block), data= data_SG_biomass_trans_surv_drought_pres, family = binomial)
...
drought_surv_model_orig= glm(surv~soil_root+as.factor(block), data= data_SG_biomass_trans_surv_drought_orig, family = binomial)
qqPlot(resid(drought_surv_model_orig))
hist(resid(drought_surv_model_orig))

Anova(drought_surv_model_orig, type=3)
#as.factor(block)   8.9261  4    0.06297 .
...
SRL_trans_model_pres= lm((SRL_length_drymass)~precip*soil_root+as.factor(block), data= SG_roottraits_pres)
...
SRL_trans_model_orig= lm((SRL_length_drymass)~precip*soil_root+as.factor(block), data= SG_roottraits_orig)
...
RLD_trans_model_pres= lm((RLD_length_volume)~precip*soil_root+as.factor(block), data= SG_roottraits_pres)
...
RLD_trans_model_orig= lm((RLD_length_volume)~precip*soil_root+as.factor(block), data= SG_roottraits_orig)
...
rhizosheath_model_pres= lm((RhizosheathSoil_DryRoots_g)~precip*soil_root+as.factor(block), data= SG_roottraits_pres)
...
#as.factor(block) 1127.3  4  2.9720  0.07396 .  
...
min(SG_roottraits_pres$RhizosheathSoil_DryRoots_g)
rhizosheath_model_orig= lm(log(RhizosheathSoil_DryRoots_g+1)~precip*soil_root+as.factor(block), data= SG_roottraits_orig)
...
SG_soil_nit_trans_model_pres= lm((ug_N_NO3_g_dry_soil)~precip*soil_root+as.factor(block), data= SG_inorg_N_trans_pres)
...
SG_soil_nit_trans_model_orig= lm((ug_N_NO3_g_dry_soil)~precip*soil_root+as.factor(block), data= SG_inorg_N_trans_orig)
...
SG_soil_amm_trans_model_pres= lm((ug_N_NH4_g_dry_soil_negto0)~precip*soil_root+as.factor(block), data= SG_inorg_N_trans_pres)
...
SG_soil_amm_trans_model_orig= lm((ug_N_NH4_g_dry_soil_negto0)~precip*soil_root+as.factor(block), data= SG_inorg_N_trans_orig)
...
SG_Soil_nit_start_pres= lm((ug_N_NO3_g_dry_soil)~soil_root+as.factor(block), data= SG_start_inorg_N_pres)
...
SG_Soil_nit_start_orig= lm((ug_N_NO3_g_dry_soil)~soil_root+as.factor(block), data= SG_start_inorg_N_orig)
...
#Start Soil ammonium
SG_Soil_amm_start_pres= lm((ug_N_NH4_g_dry_soil)~soil_root+as.factor(block), data= SG_start_inorg_N_pres)
...
#Start Soil ammonium
SG_Soil_amm_start_orig= lm((ug_N_NH4_g_dry_soil)^-1~soil_root+as.factor(block), data= SG_start_inorg_N_orig)
